...
- 🇮🇩 **[Data Rakyat](https://datarakyat.id)** — Open API for Indonesian government data. One SDK, 11 portals, 40 MCP tools. [`repo`](https://github.com/suryast/indonesia-civic-stack)
...
|------|-------------|-------|
| 🇮🇩 **[indonesia-civic-stack](https://github.com/suryast/indonesia-civic-stack)** | Python SDK + MCP + REST for 11 Indonesian gov portals — [datarakyat.id](https://datarakyat.id) | ![GitHub stars](https://img.shields.io/github/stars/suryast/indonesia-civic-stack?style=flat-square) |
